...
layout = html.Div([
    html.Div([
    html.H1("How much of the excess heat from global warming is captured in the oceans?", 
    style={'margin-left':'30%', 'margin-right':'30%'}),
    html.Div([
        html.Button("Around 10%", className="stuff", id='first_button', style={'margin':'6px'}),
        html.Button("Around 50%", className="stuff", id='second_button', style={'margin':'6px'}),
        html.Button("Around 90%", className="stuff", id='third_button', style={'margin':'6px'}),
